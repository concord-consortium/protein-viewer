...
var _proteinViewer = require('../../components/protein-viewer');
...
var workingAminoAcids = "ARDEARCFCAEDEARCDEADRCDFEARCCCDEDEAFDEADRCDARCAEEACER";
var brokenAminoAcids = "ARDEARCFCAEDEARCDEADRCDFEARCCCDEDEAFDECDRCDARCAEEACER";

var proteins = {
  working: {
    aminoAcids: workingAminoAcids,
    alleles: (0, _codonUtils.convertAminoAcidsToCodons)(workingAminoAcids),
  ...
  broken: {
    ...
    alleles: (0, _codonUtils.convertAminoAcidsToCodons)(brokenAminoAcids),
...
var ProteinWrapper = function (_Component) {
  ...
  _createClass(ProteinWrapper, [{
    ...
    value: function render() {
      var visibleProteins = this.state.display.map(function (d) {
        return proteins[d];
      });
      ...
      return _react2.default.createElement(
        ...
        (visibleProteins.length === 1 || this.state.demo) && _react2.default.createElement(
          'div',
          { className: 'example' },
          _react2.default.createElement(_proteinViewer2.default, {
            aminoAcids: visibleProteins[0].aminoAcids,
