    ...
    return (
      <div className="App">
        ...
        <div className="example">
          <Protein
            width={300}
            selectionStart={this.state.selectionStart2}
            viewBox="0 0 222 206"
            svg={
              `<g id="receptor-bound">
                  <path d="M13,21.006L13,29.006L35,43.006L56,29.006L58,13.006" style="fill:none;stroke:rgb(255,93,189);stroke-width:10px;"/>
          ...
          />
          <AminoAcidSlider
            aminoAcids="abdeabcfcaedeabcdeadbcdfeabcccdedeafdeadbcdabcaeeace"
            width={300}
            selectionStart={this.state.selectionStart2}
            updateSelectionStart={this.handleUpdateSelectionStart(2)}
          />
        </div>
        ...
        <div className="example">
          <Protein
            width={300}
            selectionStart={this.state.selectionStart3}
            viewBox="0 0 222 206"
            svg={
              `<g id="receptor-bound">
                  <path d="M13,21.006L13,29.006L35,43.006L56,29.006L58,13.006" style="fill:none;stroke:rgb(255,93,189);stroke-width:10px;"/>
          ...
          <AminoAcidSlider
            ...
            width={300}
            selectionStart={this.state.selectionStart3}
            updateSelectionStart={this.handleUpdateSelectionStart(3)}
          />
          <InfoBox
            aminoAcids="abdeabcfcaedeabcdeadbcdfeabcccdedeafdeadbcdabcaeeace"
            width={300}
