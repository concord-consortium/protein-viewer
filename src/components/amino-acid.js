...
const simpleCircle = ({width, x, y, strokeWidth, stroke, fill, scale}) => {
...
const AminoAcid = ({type="a", width=18, x=0, y=0}) => aminoAcids[type]({width, x, y});
